...
const CONFIG = {
  ...
  TECH_SCROLLER_WORDS: [
    ...
    'NBHD', 'SOFTCORE', 'NOTHING', 'ART', 'CYBERSIGILISM', 'BRAVE', 'PHONK',
    'UBUNTU', 'AFFINITY', 'FIGMA', 'YAPPER', 'TESLA', 'ESPRESSIF', 'IoT', 'IEM',
    'MIATAAA', 'CHOC CHIP COOKIES', 'OPEN SOURCE', 'CASH IS KING', 'PURPLE', 'K-POP'
  ],
  QOTD_QUOTES: [
    ...
    "'[...] those who shine brightest often burn fastest.' - Heimerdinger",
    "'There is always a choice.' - Viktor",
    "'Why is peace always the justification for violence?' - Caitlyn",
    "'Why does anyone commit acts others deem unspeakable? For love.' - Singed",
